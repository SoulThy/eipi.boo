...
This is a fun weekend project, not a whistleblower platform. If you need true anonymity, use Tor or don't even use `eipi` i would't force either. 
...
No. I built this because I wanted to learn how to build SSH apps in Rust using [russh](https://github.com/Russh/russh) and [ratatui](https://github.com/ratatui/ratatui). My friends loved the idea so I ended up publishing it. Did I use LLMs at some points to help? Yeah — the same way I use Google, Stack Overflow, or docs. Every search engine has AI in it these days. The code is fully open source, go read it.
